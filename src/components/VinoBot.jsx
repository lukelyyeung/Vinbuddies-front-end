...
export class PureVinoBot extends Component {
  constructor(props) {
    ...
    this.state = {
      steps: [
        {
          id: "welcome1",
          message: `Hey ${this.props.profile.username ||
            "Guest"}! What can I help you?`,
          trigger: "service"
        },
        {
          id: "welcome2",
          message: `So......  ${this.props.profile.username ||
            "Guest"}, What else I can help you?`,
          trigger: "service"
        },
        {
          id: "service",
  ...
  componentDidMount() {
    const root = document.querySelector('#root');
    for (const i of Object.keys(bodyStyle.vinobot)) {
      root.style[i] = bodyStyle.vinobot[i];
    }
  }
    ...
    return (
      <ThemeProvider theme={theme}>
        <ChatBot
          ...
          headerTitle="VinoBot"
          botAvatar="robot.png"
          userAvatar={this.props.profile.picture || "/common/guestuser.jpg"}
...
export const VinoBot = connect(state => ({ profile: state.profile }))(
  PureVinoBot
);
